...
export function RailwayPlanner() {
  ...
  return (
    <div className="relative flex h-screen flex-col bg-background">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-[15px] font-semibold tracking-tight text-foreground">
              Railway Route Planner - Temitope Oyadokun © 2026
            </h1>
      ...
      <footer className="relative z-10 shrink-0 border-t border-border/40 bg-card/20 px-6 py-2 text-center text-[11px] text-muted-foreground/90 backdrop-blur-sm">
      © 2026 Temitope Oyadokun. All Rights Reserved.
      </footer>
